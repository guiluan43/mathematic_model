...
cast_time=5;
explode_time=5.74;
velocity_smoke_x=140*cos(-0.35/180*pi);
velocity_smoke_y=140*sin(-0.35/180*pi);
...
[time,start_judge,end_judge]=multi_return_calculation(cast_time,explode_time,velocity_smoke_x,velocity_smoke_y)