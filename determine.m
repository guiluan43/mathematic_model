function judge=determine(judge,distance_attimet_missle_x,distance_attimet_smoke_x,distance_attimet_missle_y,distance_attimet_smoke_y,distance_attimet_missle_z,distance_attimet_smoke_z,check1_x,check1_y,t)
    ...
    theta2=acos(((distance_attimet_missle_x-distance_attimet_smoke_x)*(distance_attimet_missle_x-check1_x)+(distance_attimet_missle_y-distance_attimet_smoke_y)*(distance_attimet_missle_y-check1_y)+(distance_attimet_missle_z-distance_attimet_smoke_z-10)*(distance_attimet_missle_z))/(distance_between_check2*distance_between));
