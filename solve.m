function time=solve(distance_attimet_missle_x,distance_attimet_smoke_x,distance_attimet_missle_y,distance_attimet_smoke_y,distance_attimet_missle_z,distance_attimet_smoke_z,check1_x,check1_y)
    %{
输入参数
%}
...
%}
    ...
    distance_attimet_missle_x1_Func=matlabFunc(distance_attimet_missle_x1,'Vars',t);
    distance_attimet_missle_y1_Func=matlabFunc(distance_attimet_missle_y1,'Vars',t);
    distance_attimet_missle_z1_Func=matlabFunc(distance_attimet_missle_z1,'Vars',t);
    %{
